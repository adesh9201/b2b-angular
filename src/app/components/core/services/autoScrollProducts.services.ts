...
import { AutoscrollProductsModel } from '../models/autoScrollProducts.model';

@Injectable({
  providedIn: 'root'
})
export class AutoscrollProductsService {
  private products: AutoscrollProductsModel[] = [
    {
      id: 1,
  ...
  getAllProducts(): AutoscrollProductsModel[] {
